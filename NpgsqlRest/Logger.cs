...
public static partial class Log
{
    ...
    public static partial void InvalidHttpMethodComment(this ILogger logger, string method, string schema, string name, string usingDefault);
    ...
    [LoggerMessage(Level = LogLevel.Information, Message = "{type} {schema}.{name} has set HTTP by comment annotations to {method} {url}")]
    public static partial void CommentSetHttp(this ILogger logger, string type, string schema, string name, string method, string url);
    ...
    public static partial void InvalidParameterTypeComment(this ILogger logger, string type, string schema, string name, string defaultType);

    [LoggerMessage(Level = LogLevel.Information, Message = "{type} {schema}.{name} has set REQUEST PARAMETER TYPE by comment annotations to {requestParamType}")]
    public static partial void CommentSetParameterType(this ILogger logger, string type, string schema, string name, string requestParamType);

    [LoggerMessage(Level = LogLevel.Information, Message = "{type} {schema}.{name} has set REQUIRED AUTHORIZATION by comment annotations.")]
    public static partial void CommentSetAuth(this ILogger logger, string type, string schema, string name);

    [LoggerMessage(Level = LogLevel.Information, Message = "{type} {schema}.{name} has set COMMAND TIMEOUT by comment annotations to {parsedTimeout} seconds")]
    public static partial void CommentSetTimeout(this ILogger logger, string type, string schema, string name, string parsedTimeout);
    ...
    public static partial void InvalidTimeoutComment(this ILogger logger, string timeout, string schema, string name, string defaultTimeout);
    ...
    public static partial void InvalidRequestHeadersModeComment(this ILogger logger, string mode, string schema, string name, string defaultRequestHeadersMode);

    [LoggerMessage(Level = LogLevel.Information, Message = "{type} {schema}.{name} has set REQUEST HEADERS MODE by comment annotations to \"{requestHeadersMode}\"")]
    public static partial void CommentSetRequestHeadersMode(this ILogger logger, string type, string schema, string name, string requestHeadersMode);

    [LoggerMessage(Level = LogLevel.Information, Message = "{type} {schema}.{name} has set REQUEST HEADERS PARAMETER NAME by comment annotations to \"{requestHeadersParamName}\"")]
    public static partial void CommentSetRequestHeadersParamName(this ILogger logger, string type, string schema, string name, string requestHeadersParamName);

    [LoggerMessage(Level = LogLevel.Information, Message = "{type} {schema}.{name} has set BODY PARAMETER NAME by comment annotations to \"{bodyParamName}\"")]
    public static partial void CommentSetBodyParamName(this ILogger logger, string type, string schema, string name, string bodyParamName);
    ...
    public static partial void InvalidResponseNullHandlingModeComment(this ILogger logger, string mode, string schema, string name, string textResponseNullHandling);

    [LoggerMessage(Level = LogLevel.Information, Message = "{type} {schema}.{name} has set TEXT RESPONSE NULL HANDLING by comment annotations to \"{textResponseNullHandling}\"")]
    public static partial void CommentSetTextResponseNullHandling(this ILogger logger, string type, string schema, string name, string textResponseNullHandling);
    ...
    public static partial void InvalidQueryStringNullHandlingComment(this ILogger logger, string mode, string schema, string name, string queryStringNullHandling);

    [LoggerMessage(Level = LogLevel.Information, Message = "{type} {schema}.{name} has set QUERY STRING NULL HANDLING by comment annotations to \"{queryStringNullHandling}\"")]
    public static partial void CommentSetQueryStringNullHandling(this ILogger logger, string type, string schema, string name, string queryStringNullHandling);

    [LoggerMessage(Level = LogLevel.Information, Message = "{type} {schema}.{name} has set Content-Type HEADER by comment annotations to \"{headerValue}\"")]
    public static partial void CommentSetContentType(this ILogger logger, string type, string schema, string name, string headerValue);

    [LoggerMessage(Level = LogLevel.Information, Message = "{type} {schema}.{name} has set {headerName} HEADER by comment annotations to \"{headerValue}\"")]
    public static partial void CommentSetHeader(this ILogger logger, string type, string schema, string name, string headerName, string headerValue);
}
...
internal static class Logger
{
    ...
    private static readonly Action<ILogger, string?, string, Exception?> __LogInformationCallback =
        LoggerMessage.Define<string?, string>(LogLevel.Information, 
            new EventId(-1, nameof(__LogInformationCallback)),
            LogPattern, 
    ...
    private static readonly Action<ILogger, string?, string, Exception?> __LogWarningCallback =
        LoggerMessage.Define<string?, string>(LogLevel.Warning,
            new EventId(-1, nameof(__LogWarningCallback)),
            LogPattern,
            new LogDefineOptions() { SkipEnabledCheck = true });
    ...
    private static readonly Action<ILogger, string?, string, Exception?> __LogDebugCallback =
        LoggerMessage.Define<string?, string>(LogLevel.Debug,
            new EventId(-1, nameof(__LogDebugCallback)),
            LogPattern,
            new LogDefineOptions() { SkipEnabledCheck = true });
    ...
    private static readonly Action<ILogger, string?, string, Exception?> __LogErrorCallback =
        LoggerMessage.Define<string?, string>(LogLevel.Error,
            new EventId(-1, nameof(__LogErrorCallback)),
            LogPattern,
            new LogDefineOptions() { SkipEnabledCheck = true });

    private static readonly Action<ILogger, string?, string, Exception?> __LogTraceCallback =
        LoggerMessage.Define<string?, string>(LogLevel.Trace,
            new EventId(-1, nameof(__LogTraceCallback)),
            LogPattern,
            new LogDefineOptions() { SkipEnabledCheck = true });
