...
Changelog has been moved to main changelog file: [Changelog](https://github.com/vb-consulting/NpgsqlRest/blob/master/changelog.md)

----

Note: The changelog for the older version for client can be found here: [Changelog Archive](https://github.com/vb-consulting/NpgsqlRest/blob/master/changelog-client-old.md)
